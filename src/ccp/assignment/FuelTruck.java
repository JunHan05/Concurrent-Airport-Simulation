...
public class FuelTruck {
    ...
    public synchronized void acquire(String planeId) throws InterruptedException {
        ...
        free = false;
        System.out.println(Thread.currentThread().getName() + " : " + planeId + " secured the Fuel Truck.");
    }

    public synchronized void release(String planeId) {
        free = true;
        System.out.println(Thread.currentThread().getName() + " : " + planeId + " released the Fuel Truck.");
        notifyAll();
    }
}